...
--	(1 - 20)
	('Отыскание точек локального экстремума функции. Достаточные условия экстремума', true, 1, '20/05/2020 21:31:57'),
	('Направление выпуклости графика функции и точки перегиба. Достаточные условия перегиба.', true, 1, '20/05/2020 21:32:57'),
	('Асимптоты графика функции. Общая схема исследования графиков функций', true, 1, '20/05/2020 21:33:57'),
	('Понятие интегрируемости функции. Леммы Дарбу о верхних и нижних суммах', true, 1, '20/05/2020 21:34:57'),
	('Необходимое и достаточное условие интегрируемости',true, 1, '20/05/2020 21:35:57'),
...
--  (41 - 60)
	...
	('Регистры процессора', true, 1, '30/05/2020 20:30:56');
...
-- 8
	...
	V.', 1),
-- 9
	('Теорема о неполном базисе (формулировка)', 'latex', true,'Ким, Ильин. Линейная алгебра и аналитическая геометрия', true,
