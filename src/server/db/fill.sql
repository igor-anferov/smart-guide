...
--	(1 - 20)
	('Отыскание точек локального экстремума функции. Достаточные условия экстремума', false, 1, '20/05/2020 21:31:57'),
	('Направление выпуклости графика функции и точки перегиба. Достаточные условия перегиба.', false, 1, '20/05/2020 21:32:57'),
	('Асимптоты графика функции. Общая схема исследования графиков функций', false, 1, '20/05/2020 21:33:57'),
	('Понятие интегрируемости функции. Леммы Дарбу о верхних и нижних суммах', false, 1, '20/05/2020 21:34:57'),
	('Необходимое и достаточное условие интегрируемости',false, 1, '20/05/2020 21:35:57'),
	('Классы интегрируемых функций', false, 1, '20/05/2020 21:31:57'),
	('Основные свойства определенного интеграла. Оценки интегралов. Формулы среднего значения', false, 1, '20/05/2020 21:36:57'),
	('Основная формула интегрального исчисления. Формулы замены переменного и интегрирования по частям', false, 1, '20/05/2020 21:37:57'),
	('Понятие длины плоской кривой. Формулы для вычисления длины дуги кривой', false, 1, '20/05/2020 21:31:57'),
	('Понятие квадрируемости (площади) плоской фигуры. Площадь криволинейной трапеции и криволинейного сектора', false, 1, '20/05/2020 21:38:57'),
	('Объем тела', false, 1, '20/05/2020 21:31:57'),
	('Абсолютная сходимость несобственных интегралов. Формулы замены переменного и интегрирования по частям для несобственных интегралов', false, 1, '20/05/2020 21:39:57'),
	('Метод хорд и его обоснованиеПризнак Абеля-Дирихле. Главное значение несобственного интеграла', false, 1, '20/05/2020 21:40:57'),
	('Метод касательных и его обоснование', false, 1, '20/05/2020 21:31:57'),
	('Приближенные методы вычисления определенных интегралов ( для одного из методов вывести оценку погрешности )', false, 1, '20/05/2020 21:41:57'),
	('Различные множества точек и последовательности точек N-мерного пространства. Теорема Больцано-Вейерштрасса', false, 1, '20/05/2020 21:42:57'),
	('Понятие функции N-переменных и ее предельного значения', false, 1, '20/05/2020 21:43:57'),
	('Непрерывность функции N-переменных. Основные теоремы о непрерывных функциях', false, 1, '20/05/2020 21:44:57'),
	('Понятие дифференцируемости функции. Достаточное условие дифференцируемости. Касательная плоскость к поверхности', false, 1, '20/05/2020 21:45:57'),
	('Дифференцирование сложной функции нескольких переменных. Инвариантность формы 1‒го дифференциала.', false, 1, '20/05/2020 21:45:57'),
--  (21 - 40)
	('Система регистров процессора i386', false, 1, '28/05/2020 21:42:57'),
	('Команды процессора i386: операнды, типы операндов, разрядность операндов', false, 1, '29/05/2020 21:43:57'),
	('команда MOV и её пять основных форм в зависимости от типов операндов', false, 1, '28/05/2020 21:44:57'),
	('Прямая и косвенная адресация памяти в процессоре i386; общий вид исполнительного адреса, команда LEA', false, 1, '29/05/2020 21:45:57'),
	('сложение, вычитание и сравнение целых чисел; влияние этих операций на регистр флагов', false, 1, '29/05/2020 21:42:57'),
	('операции увеличения и уменьшения на единицу, операция смены знака, влияние этих операций на регистр флагов', false, 1, '29/05/2020 21:56:57'),
	('умножение целых чисел (знаковых и беззнаковых); влияние операций умножения на регистр флагов', false, 1, '28/05/2020 21:57:57'),
	('деление целых чисел (знаковых и беззнаковых); исключительные ситуации, связанные с делением', false, 1, '29/05/2020 21:59:57'),
	('операции знакового и беззнакового расширения разрядности', false, 1, '30/05/2020 21:42:57'),
	('побитовые логические операции', false, 1, '20/05/2020 21:43:57'),
	('операции простого и арифметического побитового сдвига', false, 1, '31/05/2020 21:44:57'),
	('классификация команд передачи управления в зависимости от <<дальности>>', false, 1, '29/05/2020 21:45:57'),
	('прямая и косвенная адресация в командах передачи управления, использование абсолютной и относительной адресации', false, 1, '28/05/2020 21:45:57'),
	('команда безусловного перехода и её возможные формы', false, 1, '29/05/2020 21:42:57'),
	('команды условных переходов в зависимости от значения отдельных флагов', false, 1, '30/05/2020 21:43:57'),
	('команды условных переходов в зависимости от результата операции над знаковыми числами', false, 1, '23/05/2020 21:44:57'),
	('команды условных переходов в зависимости от результата операции над беззнаковыми числами', false, 1, '28/05/2020 21:45:57'),
	('Организация ветвления (оператора if-else) с помощью команд условных и безусловных переходов', false, 1, '29/05/2020 21:45:57'),
	('Организация циклов с предусловием и постусловием с помощью команд условных и безусловных переходов', false, 1, '30/05/2020 21:42:57'),
	('команды LOOP и JECXZ, LOOPE/LOOPZ, LOOPNE/LOOPNZ; организация арифметических циклов', false, 1, '31/05/2020 21:43:57'),
--  (41 - 60)
	('Линейное пространство над произвольным полем. Ранг и база системы векторов.', false, 1, '27/05/2020 21:43:57'),
	('Изоморфизм линейных пространств', false, 1, '23/05/2020 21:44:57'),
	('Сумма и пересечение линейных пространств.', false, 1, '28/05/2020 21:45:57'),
	('Прямая сумма линейных пространств.', false, 1, '29/05/2020 21:45:57'),
	('Евклидово и унитарное пространство. Неравенство Коши‒Буняковского‒Шварца.', false, 1, '30/05/2020 21:42:57'),
	('Скалярное произведение в ортонормированном базисе. Существование ОНБ.', false, 1, '31/05/2020 21:43:57'),
	('Изометрия.', false, 1, '30/05/2020 21:43:57'),
	('Матрица Грама. Критерий линейной зависимости.', false, 1, '23/05/2020 21:44:57'),
	('Ортогональное дополнение. Ортогональная сумма подпространств. Расстояние от вектора до подпространства.', false, 1, '28/05/2020 21:45:57'),
	('Ортонормированный базис и унитарные (ортогональные) матрицы.', false, 1, '29/05/2020 21:45:57'),
	('Процесс ортогонализации Грама‒Шмидта. QR‒разложение матрицы.', false, 1, '30/05/2020 21:42:57'),
	('Линейное афинное  многообразие в линейном пр‒ве. Гиперплоскость.', false, 1, '31/05/2020 21:43:57'),
	('Линейные операторы (ЛО). Матрица ЛО.', false, 1, '30/05/2020 21:43:57'),
	('Матрица ЛО при переходе к другому базису. Эквивалентность и подобие матриц.', false, 1, '23/05/2020 21:44:57'),
	('Линейное пр‒во ЛО и матриц.', false, 1, '28/05/2020 21:45:57'),
	('Произведение ЛО и его матрица.', false, 1, '29/05/2020 21:45:57'),
	('Ядро и образ ЛО. Каноническая пара базисов.', false, 1, '30/05/2020 21:42:57'),
	('Линейные функционалы. Сопряженное пр‒во. Линейные функционалы и гиперплоскости.', false, 1, '31/05/2020 21:43:57'),
	('Обратный оператор и критерий обратимости.', false, 1, '30/05/2020 21:43:57'),
	('Собственные значения и векторы. Операторы простой структуры и диагонализуемые матрицы.', false, 1, '23/05/2020 21:44:57'),
	('Регистры процессора', false, 1, '30/05/2020 20:30:56');
...
-- (1 - 10)
	('Линейнoе пространсво над произвольным полем', 2, 1, false),
	('База системы векторов', 2, 1, false),
	('Pанг системы векторов', 2, 1, false),
	('эквивалентные системы векторов ', 2, 1, false),
	('базис системы векторов', 2, 1, false),
	('Теорема о неполном базисе', 2, 1, false),
	('размерность линейного пространства', 2, 1, false),
...
INSERT INTO BaseElements (title, type, is_pivotal, source, clipboard, body, author_id/* id_group, created*/) VALUES
-- 1
	('линейное пространство над произвольным полем (определение)', 'latex', true, 'Ким, Ильин. Линейная алгебра и аналитическая геометрия', false,
	...
	8. a(a + b) =   αa + αb', 1),
-- 2
	('линейное пространство над произвольным полем (примеры)', 'latex', false,'Ким, Ильин. Линейная алгебра и аналитическая геометрия', false,
	'Линейное    пр‒во  над  полем  R ‒ вещественное  линейное  пр‒во,  над  полем  C ‒
	комплексное.', 1),
-- 3
	('база системы векторов (определение)', 'latex', true,'Ким, Ильин. Линейная алгебра и аналитическая геометрия', false,
...
-- 4
	('Демонстрация возможностей базовых элементов с типом LaTeX (примеры)', 'latex', true,'https://latex.js.org/playground.html', false, '
...
INSERT INTO BaseElements (title, type, is_pivotal, source, clipboard, body, author_id/* group_id, author_id, created*/) VALUES
-- 4
	...
	равного  максимальному  числу  линейно  независимых  векторов  системы.', 1),
-- 5
	...
	максимальному  числу  линейно  независимых  векторов  системы. ', 1),
-- 6
	...
	этих  систем  выражается  через  другую', 1),
-- 7
	('эквивалентные системы векторов (следствие)', 'latex', false,'Ким, Ильин. Линейная алгебра и аналитическая геометрия', false,
...
-- 9
	...
	k < n, векторов  можно  дополнить  до  базиса.', 1),
-- 10
	...
	k +  2  векторов.  За  n ‒  k таких  шагов  мы  построим  искомый  базис  е 1 ...,е k ,...,е n .', 1),
-- 11
...
-- 13
	...
	1) φ(x + y) = φ(x) + φ(y)
	2) φ(αx)    =   αφ(x).
	Само  отображение  φ называется  изоморфизмом  линейных  пространств.', 1),
-- 14
...
-- 15
	...
	' 2  линейных  пр‒ва  над  общим  полем
		изоморфны  тогда и только тогда, когда их  размерности  равны.', 1),
-- 16
	...
	относительно  законов  композиции  в  V .', 1),
-- 17
...
-- 18
	...
	(наименьшим) среди всех других значений функции.', 1),
-- 19
	('необходимое условие экстремума (формулировка)','latex', true,'Ильин. Садовничий. Математический анализ', false,
	'если f (х) дифференцируема в
	точке с и имеет в этой точке экстремум, то  f ''(с) = 0.', 1),
-- 20
	('Первое достаточное условие экстремума (формулировка)','latex', true,'Ильин. Садовничий. Математический анализ', false,
	...
	знак слева и справа от с, то экстремума в точке с нет.', 1),
-- 21
...
-- 22
	...
	максимум, если f (2) (c) < 0, и минимум, если f (2) (c) > 0.', 1),
-- 23
	...
	справа от с => по Т1 f (х) имеет в точке с максимум (минимум).', 1),
-- 24
...
-- 25
	...
	По Т1 f (x) имеет локальный минимум в точке с.', 1),
-- 26
	...
	lim x→a+0 f(x) или lim x→a−0 f(x) равно +∞ или ‒∞.', 1),
-- 27
...
-- 29
	...
	представление
	f (х) = kx + b +α (x).
	Замечание. Для х→‒∞ все аналогично.', 1),
-- 30
	...
	перегиба.
	5°. Найти точки пересечения графика функции с осью Ох.', 1),
-- 31
	...
	она помещается в регистр команд, к которому программист обратиться не может. ', 1),
-- 32
	...
	момент времени указывает на адрес слова в области памяти, являющегося вершиной стека.', 1),
-- 33
...
INSERT INTO BaseElementTags (base_element_id, tag) VALUES
	(1, 'теорема Ферма'),
	(1, 'теоремы о точках'),
	(1, 'Ферма ключ');
